...
from modelpredict import predict, valuepredict
from plot import plot_1

with open('temp.txt', 'w') as file:
    file.write("diamond_temp.csv")
...
class MyApp(App):
    def build(self):
        ...
        self.result_menu = None  # Placeholder for result menu
    ...
    def update_result_menu_with_values(self, values):
        ...
        for param, value in zip(
            ...
            self.result_menu.add_widget(Label(text=f"{param}: {value}"))

        self.result_menu.add_widget(self.result_menu.plot_button)
        self.result_menu.add_widget(self.result_menu.back_button)
